  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        primaryOutline: "bg-white text-red-600 hover:bg-slate-100",

        secondary:
          "bg-red-600 text-primary-foreground hover:bg-red-500/90 border-blue-900 border-b-4 active:border-b-0",
        secondaryOutline: "bg-white text-red-500 hover:bg-slate-100",
        ...
        addword:
          "bg-blue-800 text-primary-foreground hover:bg-blue-800/90 border-blue-700 border-b-4 active:border-b-0",
        addwordOutline: "bg-white text-blue-500 hover:bg-slate-100",
      },
      size: {
